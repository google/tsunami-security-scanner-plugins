...
/**
 * An example Guice module that bootstraps the {@link
 * CredentialsDisclosureInGrafanaZabbixIntegrationDetector}.
 */
public final class CredentialsDisclosureInGrafanaZabbixIntegrationDetectorBootstrapModule
  ...
  protected void configurePlugin() {
    ...
    registerPlugin(CredentialsDisclosureInGrafanaZabbixIntegrationDetector.class);
  }
}
