...
import static com.google.tsunami.plugins.detectors.rce.cve202333246.RocketMqCve202333246Detector.VULNERABILITY_DESCRIPTION;
import static com.google.tsunami.plugins.detectors.rce.cve202333246.RocketMqCve202333246Detector.VULNERABILITY_ID;
import static com.google.tsunami.plugins.detectors.rce.cve202333246.RocketMqCve202333246Detector.VULNERABILITY_RECOMMENDATION;
...
public class RocketMqCve202333246DetectorTest {
  ...
  public void detect_whenVulnerable_returnsVulnerability() throws Exception {
    ...
    assertThat(detectionReports.getDetectionReportsList())
        .containsExactly(getVulnerableDetectionReport(service, targetInfo));
  }
