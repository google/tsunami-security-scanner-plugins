...
@PluginInfo(
    ...
    name = "Arbitrary File Read in ComfyUI Manager via filename Field",
    version = "0.1",
    description = "This plugin detects an unauthenticated file read in ComfyUI Manager by abusing a path traversal on the filename field of the install_module endpoint.",
...
public final class ComfyUiFileReadViaFilename implements VulnDetector {
  ...
  @VisibleForTesting
  static final String VULNERABILITY_REPORT_TITLE = "Arbitrary File Read in ComfyUI Manager via filename Field";
  ...
  private boolean isServiceVulnerable(NetworkService networkService) {
    ...
    String outputFilename = ComfyUiFileReadViaFilename.generateRandomString(OUTPUT_FILENAME_LENGTH) + ".safetensors";
