...
import static com.google.tsunami.plugins.detectors.langflow.exposed.LangflowExposedUiDetector.*;
...
/** Unit tests for {@link LangflowExposedUiDetector}. */
@RunWith(JUnit4.class)
public final class LangflowExposedUiDetectorWithCallbackServerTest {
  ...
  @Inject private LangflowExposedUiDetector detector;
  ...
  public void setUp() throws IOException {
    ...
    Guice.createInjector(
            ...
            Modules.override(new LangflowExposedUiDetectorBootstrapModule())
  ...
  @Test
  public void detect_whenVulnerableAndTcsAvailable_returnsVulnerability() throws IOException {
    mockWebServer.enqueue(
        new MockResponse()
            .setResponseCode(HttpStatus.OK.code())
            .setBody(
                "{\"version\":\"1.4.1\",\"main_version\":\"1.4.1\",\"package\":\"Langflow\"}"));
  ...
  @Test
  public void detect_whenNotVulnerableAndTcsAvailable_returnsNoVulnerability() {
    mockWebServer.enqueue(
        new MockResponse()
            .setResponseCode(HttpStatus.OK.code())
            .setBody(
                "{\"version\":\"1.4.1\",\"main_version\":\"1.4.1\",\"package\":\"Langflow\"}"));
    mockWebServer.enqueue(new MockResponse().setResponseCode(HttpStatus.FORBIDDEN.code()));
