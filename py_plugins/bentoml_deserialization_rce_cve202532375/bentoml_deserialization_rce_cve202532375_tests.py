...
from py_plugins.bentoml_deserialization_rce_cve202532375 import Cve202532375Detector
from py_plugins.bentoml_deserialization_rce_cve202532375 import _VULN_DESCRIPTION
...
class Cve202532375DetectorTest(absltest.TestCase):
    def setUp(self):
        super().setUp()
