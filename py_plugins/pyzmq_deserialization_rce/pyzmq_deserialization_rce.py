...
_VULN_DESCRIPTION = (
    'This detector checks for an exposed PyZMQ TCP server.'
)
_SLEEP_TIME_SEC = 10
...
class PyZmqRceDetector(tsunami_plugin.VulnDetector):
    ...
    def _IsPyZmqTcpService(
        ...
        logging.info('network_service_utils.get_service_name(network_service): %s',
                     network_service_utils.get_service_name(network_service))
        return network_service_utils.get_service_name(network_service) == 'zeromq zmtp 2.0'
        ...
        return detection_pb2.DetectionReport(
            ...
            vulnerability=vulnerability_pb2.Vulnerability(
                ...
                recommendation=(
                    ...
                    'should take necessary steps to secure it with proper authentication.'
                ),
                description=_VULN_DESCRIPTION,
            ),
        )
