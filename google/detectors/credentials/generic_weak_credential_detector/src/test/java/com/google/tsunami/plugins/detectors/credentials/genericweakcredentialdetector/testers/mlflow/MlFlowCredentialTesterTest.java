    ...
    private void startMockWebServer()
        ...
        final Dispatcher dispatcher = new Dispatcher() {
            ...
            public MockResponse dispatch(RecordedRequest request) {
                ...
                if (Objects.equals(request.getPath(), "/api/2.0/mlflow/users/create") && Objects.equals(request.getMethod(), "POST")) {
                    boolean isDefaultCredentials = authorizationHeader.equals(WEAK_CRED_AUTH_1) || authorizationHeader.equals(WEAK_CRED_AUTH_2);
                    if (isDefaultCredentials) {
                        return new MockResponse().setResponseCode(200)
                                .setBody("{\"user\":{\"experiment_permissions\":[],\"id\":4,\"is_admin\":false,\"registered_model_permissions\":[],\n" +
