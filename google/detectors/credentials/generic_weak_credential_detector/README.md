...
This `VulnDetector` is a generic weak credential tester
which performs the required weak crednetials detection capability for Tsunami.
It uses different testers for weak credential testing against different services.
It currently supports [ncrack](https://nmap.org/ncrack/).
