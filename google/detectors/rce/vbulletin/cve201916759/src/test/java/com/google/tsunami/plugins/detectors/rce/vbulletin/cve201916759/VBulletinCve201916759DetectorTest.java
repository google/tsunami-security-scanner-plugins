...
/** Unit tests for {@link VBulletinCve201916759Detector}. */
@RunWith(JUnit4.class)
public final class VBulletinCve201916759DetectorTest {
  private final FakeUtcClock fakeUtcClock =
      FakeUtcClock.create().setNow(Instant.parse("2020-01-01T00:00:00.00Z"));

  private MockWebServer mockWebServer;

  @Inject private VBulletinCve201916759Detector detector;
  ...
  public void setUp() {
    ...
    Guice.createInjector(
            ...
            new VBulletinCve201916759DetectorBootstrapModule())
        .injectMembers(this);
  }
  ...
  @Test
  public void detect_whenvBulletinIsVulnerable_returnsVulnerability() throws IOException {
    startMockWebServer("/", HttpStatus.OK.code(), "294b6ae1a318501bbf3d873c026fb36a");
  ...
  @Test
  public void detect_whenvBulletinIsNotVulnerable_doesNotReportVulnerability() throws IOException {
    startMockWebServer("/", HttpStatus.OK.code(), "irrelevant response");
    ImmutableList<NetworkService> httpServices =
        ImmutableList.of(
            NetworkService.newBuilder()
                .setNetworkEndpoint(
