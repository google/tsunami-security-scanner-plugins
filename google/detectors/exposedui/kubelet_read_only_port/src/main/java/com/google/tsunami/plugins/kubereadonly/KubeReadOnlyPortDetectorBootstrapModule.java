...
/** A Guice module that bootstraps the {@link KubeReadOnlyPortDetector}. */
public final class KubeReadOnlyPortDetectorBootstrapModule extends PluginBootstrapModule {
  ...
  protected void configurePlugin() {
    ...
    registerPlugin(KubeReadOnlyPortDetector.class);
  }
}
