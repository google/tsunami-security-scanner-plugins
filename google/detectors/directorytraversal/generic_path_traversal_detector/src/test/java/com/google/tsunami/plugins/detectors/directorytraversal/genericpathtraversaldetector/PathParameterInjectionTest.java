...
public final class PathParameterInjectionTest {
  ...
  @Test
  public void injectPayload_onAbsolutePathTraversalPayload_generatesExploitsForRoot() {
    HttpRequest exploitAtRoot =
        HttpRequest.get("https://google.com//etc/passwd").withEmptyHeaders().build();
  ...
  @Test
  public void injectPayload_onAbsolutePathTraversalPayload_generatesExploitsForCurrentPath() {
    HttpRequest exploitAtCurrentPath =
        HttpRequest.get("https://google.com/path/to//etc/passwd").withEmptyHeaders().build();
  ...
  @Test
  public void injectPayload_onAbsolutePathTraversalPayload_generatesExploitsForCommonPaths() {
    ImmutableSet<String> targets =
        ImmutableSet.of(
            // go/keep-sorted start
            "https://google.com/admin//etc/passwd",
