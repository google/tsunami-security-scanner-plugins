...
source ./scripts/updater/common.sh
...
# Binary proto data of previous result.
BIN_PROTO="${PROJECT_ROOT}/src/main/resources/fingerprinters/web/data/google/locust.binproto"
...
convertFingerprint "${BIN_PROTO}" "${JSON_DATA}"
