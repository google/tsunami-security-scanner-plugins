...
public final class NmapResultHandlerTest {
  ...
  @Test
  public void parse_multipleOsMatch_buildsNmapRunFromXmlDocument()
      throws IOException, SAXException {
    InputStream resource =
        getClass().getResourceAsStream("testdata/scanRunIPv6_multipleOsMatch.xml");
    NmapResultHandler nmapResultHandler = new NmapResultHandler();
