...
/** IpIdSequence element of nmap XML result. */
@AutoValue
public abstract class IpIdSequence {
  public abstract String clazz();
  public abstract String values();

  public abstract Builder toBuilder();
  public static Builder builder() {
    return new AutoValue_IpIdSequence.Builder();
  }

  /** Builder for {@link IpIdSequence}. */
  @AutoValue.Builder
  public abstract static class Builder {
    public abstract Builder setClazz(String value);
    public abstract Builder setValues(String value);

    public abstract IpIdSequence build();
  }
}
