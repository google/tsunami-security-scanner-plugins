...
/** PortUsed element of nmap XML result. */
@AutoValue
public abstract class PortUsed {
  ...
  public static Builder builder() {
    return new AutoValue_PortUsed.Builder();
  }

  /** Builder for {@link PortUsed}. */
  @AutoValue.Builder
  public abstract static class Builder {
    ...
    public abstract PortUsed build();
  }
}
