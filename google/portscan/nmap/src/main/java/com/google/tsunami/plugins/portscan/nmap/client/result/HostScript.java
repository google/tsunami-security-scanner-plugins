...
/** HostScript element of nmap XML result. */
@AutoValue
public abstract class HostScript {
  public abstract ImmutableList<Script> scripts();

  public abstract Builder toBuilder();
  public static Builder builder() {
    return new AutoValue_HostScript.Builder();
  }

  /** Builder for {@link HostScript}. */
  @AutoValue.Builder
  public abstract static class Builder {
    ...
    public abstract HostScript build();
  }
}
