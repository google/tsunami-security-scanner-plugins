...
/** PreScript element of nmap XML result. */
@AutoValue
public abstract class PreScript {
  public abstract ImmutableList<Script> scripts();

  public abstract Builder toBuilder();
  public static Builder builder() {
    return new AutoValue_PreScript.Builder();
  }

  /** Builder for {@link PreScript}. */
  @AutoValue.Builder
  public abstract static class Builder {
    ...
    public abstract PreScript build();
  }
}
