 ...
 */
package com.google.tsunami.plugins.detectors.cves.cve_2020_3452;
...
/** A {@link VulnDetector} that detects unauthenticated CVE-2020-3452 Cisco ASA/FTD directory traversal. */
@PluginInfo(
...
public final class CVE20203452Detector implements VulnDetector {
  ...
  private boolean isServiceVulnerable(NetworkService networkService) {
    String targetUri =
        NetworkServiceUtils.buildWebApplicationRootUrl(networkService) + "+CSCOT+/translation-table?"
        + "type=mst&textdomain=/%2bCSCOE%2b/../../../../..//%2bCSCOE%2b/include/browser_inc."
        + "lua&default-language&lang=../";
    try {
