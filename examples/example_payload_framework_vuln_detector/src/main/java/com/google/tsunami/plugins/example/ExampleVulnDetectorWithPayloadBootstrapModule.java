...
/** An example Guice module that bootstraps the {@link ExampleVulnDetectorWithPayload}. */
public final class ExampleVulnDetectorWithPayloadBootstrapModule extends PluginBootstrapModule {
  ...
  protected void configurePlugin() {
    ...
    registerPlugin(ExampleVulnDetectorWithPayload.class);
  }
}
