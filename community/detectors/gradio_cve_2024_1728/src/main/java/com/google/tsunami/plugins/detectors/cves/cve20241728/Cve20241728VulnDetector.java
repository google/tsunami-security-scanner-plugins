...
public final class Cve20241728VulnDetector implements VulnDetector {
  ...
  Cve20241728VulnDetector(@UtcClock Clock utcClock, HttpClient httpClient) {
    ...
    Cve20241728VulnDetector.httpClient =
    ...
    return DetectionReportList.newBuilder()
        .addAllDetectionReports(
            matchedServices.stream()
                .filter(Cve20241728VulnDetector::isWebServiceOrUnknownService)
  ...
  private static boolean checkGradioFingerprint(NetworkService networkService) {
  ...
  private boolean sendQueueViewRequest(NetworkService networkService) {
    ...
    try {
      ...
      String[] lines = httpResponse.bodyString().get().split("\\n\\n"); // Handles both \n and \r\n
