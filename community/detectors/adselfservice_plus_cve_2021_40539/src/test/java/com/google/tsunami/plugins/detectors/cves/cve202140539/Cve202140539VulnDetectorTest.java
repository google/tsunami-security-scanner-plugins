...
import static com.google.tsunami.plugins.detectors.cves.cve202140539.Cve202140539VulnDetector.DETECTION_STRING;
...
/** Unit tests for {@link Cve202140539VulnDetector}. */
@RunWith(JUnit4.class)
public final class Cve202140539VulnDetectorTest {

  private final FakeUtcClock fakeUtcClock =
      FakeUtcClock.create().setNow(Instant.parse("2020-01-01T00:00:00.00Z"));

  @Inject private Cve202140539VulnDetector detector;
  ...
  public void setUp() {
    ...
    Guice.createInjector(
            ...
            new Cve202140539DetectorBootstrapModule(),
