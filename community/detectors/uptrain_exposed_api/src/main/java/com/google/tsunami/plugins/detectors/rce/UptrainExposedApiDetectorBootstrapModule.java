...
/**
 * An Exposed Uptrain API Server Detector Guice module that bootstraps the {@link
 * UptrainExposedApiDetector}.
 */
public final class UptrainExposedApiDetectorBootstrapModule extends PluginBootstrapModule {

  @Override
  protected void configurePlugin() {
    registerPlugin(UptrainExposedApiDetector.class);
  }

  @Provides
  @UptrainExposedApiOobSleepDuration
  int provideOobSleepDuration(UptrainExposedApiDetectorConfigs configs) {
