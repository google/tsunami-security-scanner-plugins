...
public final class Cve20221388VulnDetectorTest {

  private final FakeUtcClock fakeUtcClock =
      FakeUtcClock.create().setNow(Instant.parse("2020-01-01T00:00:00.00Z"));

  @Inject private Cve20221388VulnDetector detector;
  ...
  public void setUp() {
    ...
    Guice.createInjector(
            ...
            new Cve20221388DetectorBootstrapModule(),
  ...
  public void detect_whenVulnerable_returnsVulnerability() throws IOException {
    mockWebResponse(Cve20221388VulnDetector.DETECTION_STRING);
