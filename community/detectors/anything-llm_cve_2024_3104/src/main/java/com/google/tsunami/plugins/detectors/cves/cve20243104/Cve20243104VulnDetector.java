...
public final class Cve20243104VulnDetector implements VulnDetector {
  ...
  private static final int BATCH_REQUEST_WAIT_AFTER_TIMEOUT = 5;
  ...
  Cve20243104VulnDetector(
    ...
    Cve20243104VulnDetector.httpClient =
    ...
    return DetectionReportList.newBuilder()
        .addAllDetectionReports(
            matchedServices.stream()
                .filter(Cve20243104VulnDetector::isWebServiceOrUnknownService)
