...
public final class Cve20231177Detector implements VulnDetector {
  ...
  static final String VULN_DESCRIPTION =
          "mlflow is a platform to streamline machine learning development, including tracking "
                  ...
                  + "has access.This vulnerability can read arbitrary files. Since MLflow usually configures"
                  + " s3 storage, it means that AWS account information can also be obtained, and "
                  + "information such as local ssh private keys can also be read, resulting in RCE";
