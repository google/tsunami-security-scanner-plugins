...
@PluginInfo(
    ...
    version = "0.1",
    description =
        "GoAnywhere MFT up to version 7.11 suffers from a pre-authentication command injection"
            + " vulnerability in the License Response Servlet due to deserializing an arbitrary"
