...
/** An example Guice module that bootstraps the {@link RCEViaExposedSeleniumGridDetector}. */
public final class RCEViaExposedSeleniumGridDetectorBootstrapModule extends PluginBootstrapModule {
  ...
  protected void configurePlugin() {
    ...
    registerPlugin(RCEViaExposedSeleniumGridDetector.class);
  }
}
