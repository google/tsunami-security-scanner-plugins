...
public final class Cve202229464VulnDetector implements VulnDetector {
    @VisibleForTesting static final String TEST_STR_RCE = Long.toHexString(Double.doubleToLongBits(Math.random()));
    ...
    @VisibleForTesting String buildRootUri(NetworkService networkService) {
    ...
    private boolean isServiceVulnerable(NetworkService networkService) {
        ...
        try {
            MultipartBody mBody = new MultipartBody.Builder()
                ...
                .addFormDataPart(FILE_REMOTE_LOCATION + FILE_NAME_EXT,
