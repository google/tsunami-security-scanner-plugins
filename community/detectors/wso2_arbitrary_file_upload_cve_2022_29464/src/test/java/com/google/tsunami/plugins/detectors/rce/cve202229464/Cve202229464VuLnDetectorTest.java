...
public final class Cve202229464VuLnDetectorTest {
  ...
  public void setUp() {
    ...
    targetInfo =
        TargetInfo.newBuilder()
            .addNetworkEndpoints(forHostnameAndPort(mockWebServer.getHostName(), mockWebServer.getPort()))
            .build();
  ...
  public void detect_whenVulnerable_returnsVulnerability() {
    ...
    mockWebServer.enqueue(
        new MockResponse().setResponseCode(200).setBody("1.651936903609122E12"));
    mockWebServer.enqueue(
        new MockResponse().setResponseCode(200).setBody(TEST_STR_RCE));
                    ...
                    Vulnerability.newBuilder()
                        ...
                        .setDescription(
                            "WSO2 API Manager 2.2.0, up to 4.0.0,"
                                ...
                                + "WSO2 Open Banking KM 1.4.0, up to 2.0.0 contains a arbitrary file upload"
                                + " vulnerability. Due to improper validation of user input, a malicious actor"
                                + " could upload an arbitrary file to a user controlled location of the server."
