                                    ...
                                    Vulnerability.newBuilder()
                                            ...
                                            .setDescription(
                                                    "WSO2 API Manager 2.2.0, up to 4.0.0,WSO2 Identity Server 5.2.0, up to"
                                                            + " 5.11.0,WSO2 Identity Server Analytics 5.4.0, 5.4.1, 5.5.0,"
                                                            + " 5.6.0,WSO2 Identity Server as Key Manager 5.3.0, up to"
                                                            + " 5.11.0,WSO2 Enterprise Integrator 6.2.0, up to 6.6.0,WSO2 Open"
                                                            + " Banking AM 1.4.0, up to 2.0.0,WSO2 Open Banking KM 1.4.0, up to"
                                                            + " 2.0.0 contains a arbitrary file upload vulnerability. Due to"
                                                            + " improper validation of user input, a malicious actor could"
