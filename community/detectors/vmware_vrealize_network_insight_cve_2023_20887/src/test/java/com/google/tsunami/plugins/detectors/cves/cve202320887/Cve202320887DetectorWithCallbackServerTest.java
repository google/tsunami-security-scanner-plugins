...
/** Unit tests for {@link Cve202320887Detector}. */
@RunWith(JUnit4.class)
public final class Cve202320887DetectorWithCallbackServerTest {
  private final FakeUtcClock fakeUtcClock =
      FakeUtcClock.create().setNow(Instant.parse("2024-01-29T00:00:00.00Z"));
  ...
  @Inject private Cve202320887Detector detector;
  ...
  public void setUp() throws IOException {
    ...
    Guice.createInjector(
            ...
            new Cve202320887DetectorBootstrapModule())
        .injectMembers(this);
