                    ...
                    Vulnerability.newBuilder()
                        ...
                        .setDescription(
                            "Apache Airflow Server is misconfigured and can be accessed "
                                + "publicly, Tsunami security scanner confirmed this by sending an HTTP "
                                + "request with test connection API and receiving the corresponding "
                                + "callback on tsunami callback server")
                        .setRecommendation(
