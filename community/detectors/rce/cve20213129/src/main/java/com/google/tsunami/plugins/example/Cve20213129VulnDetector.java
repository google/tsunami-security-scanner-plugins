...
public final class Cve20213129VulnDetector implements VulnDetector {
	...
	private static final String QUERY_PAYLOAD = "{\"solution\": \"Facade\\\\Ignition\\\\Solutions\\\\MakeViewVariableOptionalSolution\","
			+ "\"parameters\": {\"variableName\": \"cve20213129_tsunami\", \"viewFile\": \"phar://Tsunami_iDontExist\"}}";
	private static final CharSequence DETECTION_STRING = "file_get_contents(phar://Tsunami_iDontExist";
	...
	private DetectionReport buildDetectionReport(TargetInfo targetInfo, NetworkService vulnerableNetworkService) {
		return DetectionReport.newBuilder().setTargetInfo(targetInfo).setNetworkService(vulnerableNetworkService)
				...
				.setVulnerability(Vulnerability.newBuilder()
						...
						.setTitle("CVE-2021-3129: Laravel debug mode, unauthenticated RCE").setDescription(
