...
import com.google.tsunami.plugins.exposedui.ExposedDolibarrPanelDetector;

/** An example Guice module that bootstraps the {@link ExampleVulnDetector}. */
public final class ExposedDolibarrBootstrapDetectorModule extends PluginBootstrapModule {
  ...
  protected void configurePlugin() {
    ...
    registerPlugin(ExposedDolibarrPanelDetector.class);
  }
}
