 ...
 */
package com.google.tsunami.plugins.detectors.rce.cve202139316;
...
public final class CVE202139316VulnDetector implements VulnDetector {
	...
	private static final String CHECK_VUL_PATH = "?action=dzsap_download&link=../../../../../../../../../../../../../etc/passwd";

	public static final String DETECTION_STRING = "root:.*:0:0";
		...
		return DetectionReport.newBuilder()
				...
				.setVulnerability(
						Vulnerability.newBuilder()
								...
								.setDescription("The Zoomsounds plugin <= 6.45 for WordPress allows arbitrary files, " +
